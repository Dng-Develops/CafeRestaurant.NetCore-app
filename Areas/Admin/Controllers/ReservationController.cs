...
namespace CafeRestaurant.Areas.Admin.Controllers
{
    ...
    public class ReservationController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Phone,People,Time,Date")] Reservation reservation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Phone,People,Time,Date")] Reservation reservation)
        {
