...
namespace CafeRestaurant.Areas.Admin.Controllers
{
    ...
    public class AddressController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,Phone,Adress,Twitter,Trip,Facebook,Instagram")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,Phone,Adress,Twitter,Trip,Facebook,Instagram")] Address address)
        {
            if (id != address.Id)
            {
                return NotFound();
