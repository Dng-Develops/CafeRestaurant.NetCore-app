...
namespace CafeRestaurant.Areas.Admin.Controllers
{
    ...
    public class ContactController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Phone,Message,Date")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Phone,Message,Date")] Contact contact)
        {
            if (id != contact.Id)
            {
                return NotFound();
